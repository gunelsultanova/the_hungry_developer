...
public class StarterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Dish dishOne = new Dish("Mushroom and tofu maki", "bla bla bla bla", 999);
        Dish[] dishes = {
                new Dish("Mushroom and tofu maki", "bla bla bla bla", 999),
                new Dish("Egg and avocado urakami", "Pasta in a sauce made bla bla", 1199),
